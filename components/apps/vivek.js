  ...
  return (
    <>
      ...
      <div className=" mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
        <div>
          my name is <span className="font-bold">Saurabh Pathak</span> ,
        </div>
      ...
      <ul className=" mt-4 leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
        <li className=" list-pc">
          ...
          up{" "}
          <a className="text-underline" href="mailto:vivek.p9737@gmail.com">
            <u>saurabhpathak1356@gmail.com</u>
          </a>{" "}
          :) )
        </li>
      ...
      <ul className=" w-10/12  mt-4 ml-4 px-0 md:px-1">
        <li className="list-disc">
          <div className=" text-lg md:text-xl text-left font-bold leading-tight">
            Choudhary Charan Singh University- PDEU
          </div>
...
function Projects() {
  const project_list = [
    ...
    },
    {
      name: "Survey Form",
      date: "Dec 2021",
      link: "https://github.com/saurabhpathakk/SurveyForm",
      description: [
